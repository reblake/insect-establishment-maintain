...
# RT: alternative method to load via local files
file_list <- dir(path="C:/Users/TurnerR/OneDrive - scion/Data/Raw_Data/raw_by_country", pattern='*.csv')  # makes list of the files
file_listp <- paste0("C:/Users/TurnerR/OneDrive - scion/Data/Raw_Data/raw_by_country/", file_list)         # adds path to file names

# RT: I skipped the google drive method for now
# google drive method
# store the folder url 
folder_url <- "https://drive.google.com/drive/folders/1WD7yqnmKEJc8PK-lNmwHniEuwl-xqIby"
# identify this folder on Drive ; let googledrive know this is a file ID or URL, as opposed to file name # RT I got a different question and it wanted access to my gmail account
...
tax_table <- read.csv("C:/Users/TurnerR/OneDrive - scion/Data/Raw_Data/Establishments/Old_files/taxonomy_table.csv", stringsAsFactors=F)
